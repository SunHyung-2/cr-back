 ...
 * SA001A010과 같은 역할을 하는 메소드이지만 핸들러 예시를 위하여 만든 객체입니다.
 * 
 * @author douzone
 *
 */
@Component("SA001A011")
public class SA001A011 extends AbstarctHandler {
	...
	public Object handle(RequestInfo requestInfo, RequestModel requestModel, String ApiCode, Locale locale) {
		...
		result = (Map<String, Object>) commonMapper.selectCompList(params);
		return result;
	}
